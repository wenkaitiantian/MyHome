...
<body>
	<div class="content">
		<table class="table">
				<caption><h4>
					<b style="display: inline-block;">信息审核</b>
					<center>
						<b style="display: inline-block;">
							<form action="<%=path%>/admin_getSelectPost.action" method="post">
				...
				<s:iterator value="#request.posts" id="post">
					<tr>
						...
						<td>
							<a class="del" value="<s:property value="#post.id"/>">删除</a>
						</td>
					</tr>
				</s:iterator>
		</table>
...
<script>
	$(function(){
		$(".del").click(function(){
			...
			$.post("<%=path%>/admin_deletePost.action",{delId:a},function(data,textStatus){
			})
		});
	})
</script>
