...
<div class="container">
    <form action="<%=path%>/post_getCastQuery.action?tab=<%="3"%>" method="post" id="cast">
        <div class="top">
    ...
    <div class="tab">
        <div>
            ...
            <a href="<%=path%>/post_query.action?tab=<%="2"%>"><div class="tabselect">房屋出售</div></a>
            <a href="<%=path%>/post_query.action?tab=<%="3"%>"><div class="tabselect highlight">房屋求租</div></a>
        </div>
        <div>
            ...
            <div class="rentneedblock" style="display:none;">
                ...
                <div class="rentneed">
                    ...
                    <div>
                        ...
                        <div style="font-family:微软雅黑;font-weight: bold;"><s:property value="#help.title"/></div>
                        </a>
