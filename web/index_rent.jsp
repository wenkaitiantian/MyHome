...
<div class="container">
    ...
    <div class="tab">
        <div>
            <a href="<%=path%>/post_query.action?tab=<%="1"%>"><div class="tabselect highlight">房屋出租</div></a>
                    ...
                    <div class="rent">
                        <div class="picture">
                            <a href="<%=path%>/post_detail.action?detail=<s:property value="#post.id"/>">
                                <img src="img/m2.jpg" width="100%" height="100%">
                            </a>
                        </div>
                        <div>
                            <a style="text-decoration: none" href="<%=path%>/post_detail.action?detail=<s:property value="#post.id"/>">
                            <div style="font-family:微软雅黑;font-weight: bold;"><s:property value="#post.title"/></div></a>
