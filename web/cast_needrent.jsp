...
<div class="container">
    <form action="<%=path%>/post_getCastQuery.action?tab=<%="1"%>" method="post" id="cast">
        <div class="top">
            <div class="logo"><a href="<%=path%>/post_query.action?tab=<%="1"%>"><img src="img/logo.jpg" width="100%" height="100%"/></a></div>
            <div></div>
            <div>
                <div class="search">
                    <span>
    ...
    <div class="tab">
        <div>
            ...
            <a href="<%=path%>/post_getCastQuery.action?tab=<%="2"%>&cast=<s:property value="#session.cast"/>"><div class="tabselect">房屋出售</div></a>
            <a href="<%=path%>/post_getCastQuery.action?tab=<%="3"%>&cast=<s:property value="#session.cast"/>"><div class="tabselect highlight">房屋求租</div></a>
        </div>
        <div>
